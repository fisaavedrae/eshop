...
const VistaRapidaProducto = (props) => {
  ...
  return (
    <>
      <Transition.Root show={openVistaRapida} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={setOpenVistaRapida}>
          <Transition.Child
            as={Fragment}
                ...
                <Dialog.Panel className="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
                  <div className="relative flex w-full items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                    <button
                      ...
                      onClick={() => setOpenVistaRapida(false)}
                    >
                        ...
                        >
                          ...
                          <div className="mt-6">
                            ...
                            <div className="flex items-center">
                              ...
                              <p className="sr-only">
                                {producto.rating} out of 5 stars
                              </p>
                              <a
                                href="#"
