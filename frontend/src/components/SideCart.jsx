...
import { PlusIcon, MinusIcon, XMarkIcon, TrashIcon } from '@heroicons/react/24/outline'
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      <div className="flex items-start justify-between border-b border-gray-200 px-1 pb-2 ">
                        <Dialog.Title className="text-lg font-medium text-gray-900">Tu Carrito ({products.length}) items</Dialog.Title>
                                ...
                                <div className="ml-4 flex flex-1 flex-col gap-2">
                                  <div>
                                    <div className="flex justify-between text-base font-normal text-gray-900">
                                      ...
                                      <div>
                                        <button>
                                        <TrashIcon className="h-5 w-5 text-gray-700" aria-hidden="true" />
                                        </button>
                                      </div>
                                  ...
                                  <div className="flex flex-1 items-end justify-between text-sm">
                                    <div className='flex border border-gray-200 py-0.5 px-0.5 '>  
                                      <div className=' border flex items-center'>
                                        <button type='button' className='py-1 bg-gray-100 text-gray-00  hover:bg-gray-200 hover:text-black'>
